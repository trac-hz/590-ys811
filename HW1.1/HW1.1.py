...
data0=pd.read_json("/Users/tracysheng/590-CODES/DATA/weight.json")   
data=data0[data0.x<18]
x=data.x
y=data.y
...
#---------------------------------------
#Developing Linear regression (fit to age<18)
